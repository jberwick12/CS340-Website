module.exports = function(){
    ...
    function getPlayerAwards(res, mysql, context, complete){
        mysql.pool.query("SELECT p.name as Player, a.name as Award FROM player_award INNER JOIN player p ON p.id = player_id INNER JOIN awards a ON a.id = award_id", function(error, results, fields){
            if(error){
    ...
    router.post('/', function(req, res){
        ...
        var mysql = req.app.get('mysql');
        var sql = "INSERT INTO player (player_id, award_id) VALUES (?,?)";
        var inserts = [req.body.player_id, req.body.award_id];
