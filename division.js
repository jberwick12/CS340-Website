module.exports = function(){
    ...
    function getDivisions(res, mysql, context, complete){
        mysql.pool.query("SELECT division.id as id, league.name as league, region FROM division INNER JOIN league ON league_id = league.id", function(error, results, fields){
            if(error){
                res.write(JSON.stringify(error));
                res.end();
            }
    ...
    router.post('/', function(req, res){
        ...
        var inserts = [req.body.league_id, req.body.region];
