module.exports = function(){
    ...
    function getTeams(res, mysql, context, complete){
        mysql.pool.query("SELECT id, city, name, primary_color, secondary_color, tertiary_color, coach, owner, ballpark FROM team", function(error, results, fields){
            if(error){
    ...
    router.post('/', function(req, res){
        ...
        var mysql = req.app.get('mysql');
        var sql = "INSERT INTO team (division_id, name, city, primary_color, secondary_color, tertiary_color, coach, owner, ballpark) VALUES (?,?,?,?,?,?,?,?,?)";
        var inserts = [req.body.division_id, req.body.name, req.body.city, req.body.primary_color, req.body.secondary_color, req.body.tertiary_color, req.body.coach, req.body.owner, req.body.ballpark];
